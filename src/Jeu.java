...
public class Jeu {
    ...
    public static void lancerJeu(){
        ...
        System.out.println(QUI_JOUE + 1);
        Joueur joueur1 = new Joueur(scanner.nextLine());
        System.out.println(QUI_JOUE +2);
        ...
        do{
            ...
            saisiUtilisateur = scanner.next().charAt(0);
            result = Character.compare(commenceJeux, saisiUtilisateur);
        }while(result == 0);
